...
function FaqPage() {
  ...
  }, [toggleState]); // Added dependency so it refreshes when tab changes
  ...
  return (
    <div className="faq-page" style={{ minHeight: '100vh', overflowY: 'auto' }}>
      ...
      <div className="main" style={{ paddingTop: "120px", minHeight: "100vh", overflowY: "auto" }}>
          ...
          <div className="content-tabs">
            ...
            >
              <div className="accordion">
                {leetCodeQuestions.map((item, index) => (
                  <div
                    ...
                    style={{
                      backgroundColor:
                        hoveredIndex === index ? "#f5f5f5" : "#ffffff",
                    }}
                  >
                    <div
            ...
            >
              <div className="accordion">
                {behavioralInterviewQuestions.map((item, index) => (
                  <div
                    className={`accordion-item ${openIndex === index ? "active" : ""}`}
                    key={index}
                    onMouseEnter={() => setHoveredIndex(index)}
