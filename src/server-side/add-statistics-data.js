  ...
  try {
    ...
    const statisticsData = [
      ...
      },
      {
        ...
        higherStudiesStatistics: { department: 'IT', percentageHigherStudies: 25 }
      },
      {
        academicYear: '2023-24',
      ...
      // Data for AIDS department
      {
        ...
        higherStudiesStatistics: { department: 'EXTC', percentageHigherStudies: 21 }
      },
      {
        academicYear: '2021-22',
        ctcStatistics: { averageCTC: 11.50, medianCTC: 9.80 },
        placementStatistics: { department: 'AIDS', percentagePlaced: 93 },
        higherStudiesStatistics: { department: 'EXTC', percentageHigherStudies: 23 }
      },
      {
        academicYear: '2022-23',
